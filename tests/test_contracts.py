...
class ContractTests(unittest.TestCase):
    def test_paired_contract_and_operator_have_no_credential_authority(self) -> None:
        ...
        self.assertFalse(paired["automatic_lesson_promotion"])
        self.assertFalse(operator["loops"][2]["automatic_promotion"])
        self.assertFalse(operator["loops"][2]["source_self_edit"])
